...
export default function PokemonPage() {
    ...
    useEffect(() => {
        if (pokemon_id) {
            try {
                fetch(`https://pokeapi.co/api/v2/pokemon/${pokemon_id}`, { method: 'GET' })
                ...
                setResponseMessage("Falhamos ao buscar os pokemons disponíveis, sentimos muito!")
            }
        } else {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-stone-90 from-[#000a0f]  to-[#023047]">
            ...
            {pokemon &&
                <section className="min-h-screen w-full flex flex-col justify-center p-20">
                    <div className="flex flex-col gap-4 mx-auto mb-8">
                        <img className="h-96 w-96" src={pokemon.sprites.other?.dream_world?.front_default || pokemon.sprites.front_default} alt="" />
                    ...
                    <div className="flex flex-col lg:flex-row w-full gap-4">
                        <div className="bg-stone-800 p-6 rounded-2xl border border-neutral-700 w-full flex flex-col">
                            ...
                            <ul className="">
                                ...
                                <li>Base expirience: <span>{pokemon.base_experience}</span></li>
                            </ul>
                        </div>
                        <div className="bg-stone-800 p-6 rounded-2xl border border-neutral-700 w-full flex flex-col">
                                ...
                                {pokemon.abilities.map((abilitie, index) =>
                                    <li className="flex flex-row justify-between" key={index}>
                                        ...
                                        <div className="flex flex-row text-nowrap gap-2">
                                            <p className="">{abilitie.is_hidden ? 'Sim' : 'Não'} </p>
